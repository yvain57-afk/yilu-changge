...
export class Platform {
 book: Book; music: AudioSource; private effects:Record<string,AudioSource>={};private active=false; clips:Record<string,AudioClip>={}; hidden=false;
 ...
 get audioState(){return {active:this.active,hidden:this.hidden,musicPlaying:this.music.playing,effectChannels:Object.keys(this.effects).length,playingEffects:Object.keys(this.effects).filter(k=>this.effects[k].playing)};}
