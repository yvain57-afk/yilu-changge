...
writeFileSync('evidence/v06/fingerprint.json',JSON.stringify({version:'v06-rc1',sourceHash,source,web:bundle('build/web-mobile'),wechat:bundle('build/wechatgame'),localTestIdentityExcluded:true},null,2));console.log(sourceHash);
