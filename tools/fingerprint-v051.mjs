...
writeFileSync('evidence/v051/fingerprint.json',JSON.stringify({version:'v051-rc1',sourceHash,source,web:bundle('build/web-mobile'),wechat:bundle('build/wechatgame'),localTestIdentityExcluded:true},null,2));console.log(sourceHash);
