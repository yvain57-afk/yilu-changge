import {open,steer,freshSave,root,startCapture,stopCapture} from './browser-battle-rework-common.mjs';
...
const t=await open('natural-delivery',{audio:true}),runs=[],timeline=[],report={attemptId,attemptDir,passed:false,scope:'One real-time continuous three-level run driven only by touch input; no injected troops, HP, equipment or time'},start=Date.now();
