...
const evidence=process.env.YILU_EVIDENCE_DIR||'evidence/v03';mkdirSync(evidence,{recursive:true});writeFileSync(`${evidence}/negative-gate.txt`,run.stdout+run.stderr);
