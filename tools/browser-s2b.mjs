...
const root='evidence/v02-s2b';mkdirSync(`${root}/recordings`,{recursive:true});
const context=await chromium.launchPersistentContext('.cache/browser-s2b',{executablePath:'/Applications/Google Chrome.app/Contents/MacOS/Google Chrome',headless:false,viewport:{width:390,height:844},hasTouch:true,isMobile:true,recordVideo:{dir:`${root}/recordings`,size:{width:390,height:844}},args:['--disable-background-timer-throttling','--disable-renderer-backgrounding','--disable-backgrounding-occluded-windows']});
...
const boot=async()=>{await page.goto('http://127.0.0.1:43187');await page.bringToFront();await page.waitForFunction(()=>globalThis.__YLCG__?.snapshot().version==='v02-s2b',null,{timeout:30000});};
